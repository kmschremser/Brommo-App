                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group has-focused">
                                        ...
                                        <input type="number" name="purchaseprice" id="purchaseprice" value="<?php if ( isset( $rei['purchaseprice'] ) ) echo $rei['purchaseprice']; ?>" placeholder="<?php echo $this->lang->line('Purchase price'); ?> <?php echo $CURRENCY; ?>" data-parsley-type="alphanum" data-parsley-required class="form-control has-feedback-left parsley-error">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group has-focused">                                      
                                      ...
                                      <input type="number" name="purchasepricenet" id="purchasepricenet" value="<?php if ( isset( $rei['purchasepricenet'] ) ) echo $rei['purchasepricenet']; ?>" placeholder="<?php echo $this->lang->line('Purchase price'); ?> <?php echo $this->lang->line('net'); ?> <?php echo $CURRENCY; ?>" data-parsley-type="alphanum" data-parsley-required class="form-control has-feedback-left parsley-error">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                      ...
                                      <input type="number" name="garage" id="garage" value="<?php if ( isset( $rei['garage'] ) ) echo $rei['garage']; ?>" placeholder="<?php echo $this->lang->line('Garage'); ?> <?php echo $CURRENCY; ?>" data-parsley-type="number" data-parsley-length="[1, 10]" class="form-control has-feedback-left">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group has-focused form-input-icon">
                                      ...
                                      <input type="number" name="renovationprice" id="renovationprice" value="<?php if ( isset( $rei['renovationprice'] ) ) echo $rei['renovationprice']; ?>" placeholder="<?php echo $this->lang->line('Renovation'); ?> <?php echo $CURRENCY; ?>" data-parsley-type="alphanum" data-parsley-length="[1, 10]" class="form-control has-feedback-left">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group color-info">
                                      <label for="overheads"><?php echo $this->lang->line('Overheads'); ?></label><br />
                                        <sup>&nbsp;</sup>
                                      <input type="text" name="overheads" id="overheads" value="<?php if ( isset( $rei['overheads'] ) ) echo $rei['overheads']; ?>" placeholder="<?php echo $this->lang->line('Overheads'); ?> <?php echo $CURRENCY; ?>"data-parsley-type="alphanum" class="form-control">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group color-info">
                                      <label for="reserve"><?php echo $this->lang->line('Reserve'); ?></label><br />
                                       <sup>&nbsp;</sup>
                                      <input type="text" name="reserve" id="reserve" value="<?php if ( isset( $rei['reserve'] ) ) echo $rei['reserve']; ?>" placeholder="<?php echo $this->lang->line('Reserve'); ?> <?php echo $CURRENCY; ?>" data-parsley-type="alphanum" class="form-control">
