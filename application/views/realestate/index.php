...
//-->                            
                            ...
                            <td class=" ">€ <?php echo number_format($object_item['purchaseprice'],2,'.',','); ?> <!--<i class="success fa fa-long-arrow-up"></i>--> <a href="<?php echo site_url('realestate/delete/'.$object_item['objid']); ?>">[X]</a><br />
                              Equity <?php echo number_format($object_item['equityratio']*100,0,'.',','); ?>%</td>
                            ...
                            <td class=" last">
                              ...
                              <a href="<?php echo site_url('realestate/edit/'.$object_item['objid']); ?>">[Edit]</a><br />
                              <a href="#">^ Upvote</a><br />
                              <a href="#">v Downvote</a>
