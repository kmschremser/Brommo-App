                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="color-success"><?php echo number_format($rei['purchaseprice'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></span></td>
                                </tr>
<?php if ( $rei['vatreduction'] == 1 ) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo number_format(($rei['purchasepricenet']), 2, '.', ','); ?> <?php echo $CURRENCY; ?>
                                    </td>
                                </tr>
<?php } ?>
                                <tr>
...
<?php $total_price = $rei['total_price']; ?>
                              ...
                              <tr>
                                ...
                                <td class="color-info"><strong><?php echo number_format($rei['total_price'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></strong></td>
                              </tr>
<!--//
                              <tr>
                                <th><?php echo $this->lang->line('Price per m2') . ' ' . $this->lang->line('(excl. garage)'); ?>:</th>
                                <td><?php echo number_format(($rei['price_per_m2_exclgarage']), 2, '.',','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><?php echo $this->lang->line('Price per m2') . ' ' . $this->lang->line('(excl. outdoor)'); ?>:</th>
                                <td><?php echo number_format(($rei['price_per_m2']), 2, '.',','); ?> <?php echo $CURRENCY; ?></td>
                              </tr> 
//-->                                  
                              <tr>
...
<?php if ( isset( $rei['avg_price'] ) ) { ?>                              
                              <tr>
                                ...
                                <td><?php echo number_format($rei['avg_price'], 2, '.',','); ?> <?php echo $CURRENCY; ?> <br />(
<?php 
    if ( $rei['diff_price'] > 0 ) 
                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    <div class="profile-user-skills">
                                        ...
                                        <span class="color-info"><?php echo number_format( ($rei['rentgross']/$rei['total_size']), 2, '.', ',' ); ?> <?php echo $CURRENCY; ?> <?php echo $this->lang->line('per m2'); ?>)</span><br />
                                        (<?php echo $this->lang->line('incl. overheads, reserve &amp; taxes'); ?>)</span></h5>
                                        <p>
                                            <?php echo $this->lang->line('Rent net per m2 (incl. 50% outdoor)'); ?> 
                                            <?php echo number_format( $rei['rent_net_per_m2'], 2, '.', ',' ); ?> <?php echo $CURRENCY; ?>
                                        </p>
...
-->                            
                            <tbody>
                              <tr>
                                ...
                                <td><?php echo number_format($rei['renovationprice'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Price of garage'); ?>:</code></th>
                                <td><?php echo number_format($rei['garage'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>       
...
<?php $agentprice = $rei['agentprice']; ?>  
                              ...
                              <tr>
                                ...
                                <td><?php echo number_format($rei['agentprice'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Lawyer / Notary'); ?>:</code></th>
                                <td><?php echo number_format(($rei['notary']), 2, '.', ','); // 2,0% ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Purchase Tax / Land registry'); ?>:</code></th>
                                <td><?php echo number_format(($rei['landregistry']), 2, '.', ','); // 4,6% ?> <?php echo $CURRENCY; ?></td>
                              </tr>
...
<?php if ( $rei['loanregistrycost'] ) { ?>
                              ...
                              <tr>
                                ...
                                <td><?php echo number_format(($rei['loanregistrycost']), 2, '.', ','); // 2,3% ?> <?php echo $CURRENCY; ?></td>
                              </tr>
...
//-->
                              ...
                              <tr>
                                ...
                                <td><?php echo number_format($rei['loansum'], 2, '.',','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Loan rate'); ?> <?php echo $this->lang->line('p.a.'); ?>:</code></th>
                                <td><?php echo number_format($rei['loan_rate'], 2, '.',','); ?> <?php echo $CURRENCY; ?><br />
                                  (<?php echo number_format($rei['loan_rate']/12, 2, '.',','); ?> <?php echo $CURRENCY; ?> <?php echo $this->lang->line('p.m.'); ?>)
                                </td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Payback'); ?> <?php echo $this->lang->line('p.a.'); ?>:</code></th>                                
                                <td><?php echo number_format($rei['capital_payback'], 2, '.',','); ?> <?php echo $CURRENCY; ?><br />
                                  (<?php echo number_format($rei['capital_payback']/12, 2, '.',','); ?> <?php echo $CURRENCY; ?> <?php echo $this->lang->line('p.m.'); ?>)
                                </td>
                              </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                              ...
                              <tr>
                                ...
                                <td><?php echo number_format($rei['risk'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>

                              <tr>
                                <th><code><?php echo $this->lang->line('Refurbishment p.a (1 € per m2)'); ?>:</code></th>
                                <td><?php echo number_format($rei['refurb'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>  

<?php if ( $rei['vatreduction'] == 1 ) { ?>
                              <tr>
                                <th><code><?php echo $this->lang->line('VAT reduction'); ?>:</code></th>
                                <td><?php echo number_format($rei['vat_red'], 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>  
<?php } else $data['vat_red'] = 0; ?>
                              ...
                              <tr>
                                ...
                                <td><?php echo number_format(($rei['depreciation'] * -1), 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Loan rate'); ?> <?php echo $this->lang->line('p.a.'); ?></code></th>
                                <td><?php echo number_format(($rei['loan_rate'] * -1), 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Profite'); ?> <?php echo $this->lang->line('p.a.'); ?></code></th>
                                <td><?php echo "<span class='blue'><b>" . number_format($rei['profite'], 2, '.', ',')  . "</b></span>"; ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Taxes'); ?> <?php echo $this->lang->line('p.a.'); ?></code></th>
                                <td><?php echo number_format(($rei['taxes']), 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                ...
                                <td class="color-warnings"><?php echo number_format($rei['earnings'], 2, '.', ','); ?> <?php echo $CURRENCY; ?><br />
                                <?php echo number_format($rei['earnings']/12, 2, '.', ','); ?> <?php echo $CURRENCY; ?> <?php echo $this->lang->line('p.m.'); ?><br />
                              </td>
                              </tr>
                              <tr>
...
<?php  echo number_format($rei['cashflow']/12, 2, '.', ','); ?> <?php echo $CURRENCY; ?> <?php echo $this->lang->line('p.m.'); ?>
                              ...
                              <tr>
                                ...
                                <td><?php 
                                echo number_format((($rei['risk']+$rei['refurb'])*-1), 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
                                <th><code><?php echo $this->lang->line('Cashflow p.a. (with risk+refurb)'); ?></code></th>
                                <td class="info"><?php 
                                echo number_format(($rei['cashflow2']), 2, '.', ','); ?> <?php echo $CURRENCY; ?></td>
                              </tr>
                              <tr>
    ...
    $(function () {
        ...
        var chartDoughnut = {
            labels: [
                ...
                "<?php echo $this->lang->line('Reserve'); ?>: <?php echo number_format($rei['reserve'], 2, '.', ','); ?> <?php echo $CURRENCY; ?>",
                "<?php echo $this->lang->line('Tax'); ?> (10%): <?php echo number_format( $rei['rent_net_tax'], 2, '.', ',' ); ?> <?php echo $CURRENCY; ?>",
